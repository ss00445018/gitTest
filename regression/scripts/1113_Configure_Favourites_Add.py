...
# Application: QSpace
# Release: 2019.06
# Test Case: Configure_Favourites_Add
# Created On: Mon Sep 30 09:12:20 IST 2019
# Created By: iTM
#
print("Executing 1113_Configure_Favourites_Add.py")
...
def Configure_Favourites_Add():
	...
	saveScreenshot("{}_Step_1_1569814939874.png".format(testData["runId"]))
	test_step_status(1, resultMsg, "", "Action", "Passed", "{}_Step_1_1569814939874.png".format(testData["runId"]))
	try:
		...
		saveScreenshot("{}_Step_1_1569814939920_Error.png".format(testData["runId"]))
		test_step_status(1, resultMsg, e, "Verification", "Failed", "{}_Step_1_1569814939920_Error.png".format(testData["runId"]))
		handleException(e, "Mandatory")
		return

	saveScreenshot("{}_Step_1_1569814939926.png".format(testData["runId"]))
	test_step_status(1, resultMsg, "", "Verification", "Passed", "{}_Step_1_1569814939926.png".format(testData["runId"]))
	#
	...
	try:
		...
		saveScreenshot("{}_Step_2_1569814939953_Error.png".format(testData["runId"]))
		test_step_status(2, resultMsg, e, "Action", "Failed", "{}_Step_2_1569814939953_Error.png".format(testData["runId"]))
		handleException(e, "Mandatory")
		return

	saveScreenshot("{}_Step_2_1569814939959.png".format(testData["runId"]))
	test_step_status(2, resultMsg, "", "Action", "Passed", "{}_Step_2_1569814939959.png".format(testData["runId"]))
	#
	...
	try:
		...
		saveScreenshot("{}_Step_3_1569814939973_Error.png".format(testData["runId"]))
		test_step_status(3, resultMsg, e, "Action", "Failed", "{}_Step_3_1569814939973_Error.png".format(testData["runId"]))
		handleException(e, "Mandatory")
		return

	saveScreenshot("{}_Step_3_1569814939977.png".format(testData["runId"]))
	test_step_status(3, resultMsg, "", "Action", "Passed", "{}_Step_3_1569814939977.png".format(testData["runId"]))
	#
	...
	try:
		...
		saveScreenshot("{}_Step_4_1569814939992_Error.png".format(testData["runId"]))
		test_step_status(4, resultMsg, e, "Action", "Failed", "{}_Step_4_1569814939992_Error.png".format(testData["runId"]))
		handleException(e, "Mandatory")
		return

	saveScreenshot("{}_Step_4_1569814939998.png".format(testData["runId"]))
	test_step_status(4, resultMsg, "", "Action", "Passed", "{}_Step_4_1569814939998.png".format(testData["runId"]))
	try:
		...
		saveScreenshot("{}_Step_4_1569814940008_Error.png".format(testData["runId"]))
		test_step_status(4, resultMsg, e, "Verification", "Failed", "{}_Step_4_1569814940008_Error.png".format(testData["runId"]))
		handleException(e, "Mandatory")
		return

	saveScreenshot("{}_Step_4_1569814940019.png".format(testData["runId"]))
	test_step_status(4, resultMsg, "", "Verification", "Passed", "{}_Step_4_1569814940019.png".format(testData["runId"]))
	#
	...
	try:
		...
		saveScreenshot("{}_Step_5_1569814940025_Error.png".format(testData["runId"]))
		test_step_status(5, resultMsg, e, "Action", "Failed", "{}_Step_5_1569814940025_Error.png".format(testData["runId"]))
		handleException(e, "Mandatory")
		return

	saveScreenshot("{}_Step_5_1569814940030.png".format(testData["runId"]))
	test_step_status(5, resultMsg, "", "Action", "Passed", "{}_Step_5_1569814940030.png".format(testData["runId"]))
	try:
		...
		resultMsg = "See additional message and/or iAF logs"
		logger.info("See additional message and/or iAF logs")
		saveScreenshot("{}_Step_5_1569814940033_Error.png".format(testData["runId"]))
		test_step_status(5, resultMsg, e, "Verification", "Failed", "{}_Step_5_1569814940033_Error.png".format(testData["runId"]))
		handleException(e, "Mandatory")
		return

	saveScreenshot("{}_Step_5_1569814940037.png".format(testData["runId"]))
	test_step_status(5, resultMsg, "", "Verification", "Passed", "{}_Step_5_1569814940037.png".format(testData["runId"]))
	#
	...
	try:
		...
		saveScreenshot("{}_Step_6_1569814940053_Error.png".format(testData["runId"]))
		test_step_status(6, resultMsg, e, "Action", "Failed", "{}_Step_6_1569814940053_Error.png".format(testData["runId"]))
		handleException(e, "Mandatory")
		return

	saveScreenshot("{}_Step_6_1569814940064.png".format(testData["runId"]))
	test_step_status(6, resultMsg, "", "Action", "Passed", "{}_Step_6_1569814940064.png".format(testData["runId"]))
	#
	# Step 7, Must Pass Indicator: Mandatory
	# Description: QSpace - Click AddFavourites Button in the Main Page,
	# Expected Result: Do Nothing
	#
	logger.info("Executing Test Step [7]")
	try:
		driver.find_element(By.XPATH, "//input[@id='btnAdd']").click()
		resultMsg = "Clicking on AddFavourites button on Page Main successful"
		logger.info("Clicking on AddFavourites button on Page Main successful")
	except Exception as e:
		resultMsg = "Clicking on AddFavourites button on Page Main Failed"
		logger.info("Clicking on AddFavourites button on Page Main Failed")
		saveScreenshot("{}_Step_7_1569814940069_Error.png".format(testData["runId"]))
		test_step_status(7, resultMsg, e, "Action", "Failed", "{}_Step_7_1569814940069_Error.png".format(testData["runId"]))
		handleException(e, "Mandatory")
		return

	saveScreenshot("{}_Step_7_1569814940071.png".format(testData["runId"]))
	test_step_status(7, resultMsg, "", "Action", "Passed", "{}_Step_7_1569814940071.png".format(testData["runId"]))
	#
	...
	try:
		...
		saveScreenshot("{}_Step_8_1569814940078_Error.png".format(testData["runId"]))
		test_step_status(8, resultMsg, e, "Action", "Failed", "{}_Step_8_1569814940078_Error.png".format(testData["runId"]))
		handleException(e, "Mandatory")
		return

	saveScreenshot("{}_Step_8_1569814940082.png".format(testData["runId"]))
	test_step_status(8, resultMsg, "", "Action", "Passed", "{}_Step_8_1569814940082.png".format(testData["runId"]))
	#
	...
	try:
		...
		saveScreenshot("{}_Step_9_1569814940090_Error.png".format(testData["runId"]))
		test_step_status(9, resultMsg, e, "Action", "Failed", "{}_Step_9_1569814940090_Error.png".format(testData["runId"]))
		handleException(e, "Mandatory")
		return

	saveScreenshot("{}_Step_9_1569814940116.png".format(testData["runId"]))
	test_step_status(9, resultMsg, "", "Action", "Passed", "{}_Step_9_1569814940116.png".format(testData["runId"]))
	#
	...
	try:
		...
		saveScreenshot("{}_Step_10_1569814940128_Error.png".format(testData["runId"]))
		test_step_status(10, resultMsg, e, "Action", "Failed", "{}_Step_10_1569814940128_Error.png".format(testData["runId"]))
		handleException(e, "Mandatory")
		return

#
if test_case_continue: Configure_Favourites_Add()
