...
def test_case_status(dispatchId, batchId, callingStep, _iter, tcName):
	global test_case
	test_case = []
	if _instType == 'Action': 
		status['endTime'] = current_time()
	...
	print("Test Case: [{}], Status: [{}], Start Time: [{}], End Time: [{}]".format(tcName, data['status'], data['startTime'], data['endTime']))
